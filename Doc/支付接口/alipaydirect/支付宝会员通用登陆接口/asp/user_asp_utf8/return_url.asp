...
if verify_result then	'验证成功
    '获取支付宝的通知返回参数
    user_id		= request.QueryString("user_id")	'获取支付宝用户唯一ID号
...
<table align="center" width="350" cellpadding="5" cellspacing="0">
  <tr>
    <td align="center" class="font_title">亲爱的商城会员：<%=request.QueryString("user_id")%>：<br />您已经登录成功</td>
  </tr>
</table>
<%
else
