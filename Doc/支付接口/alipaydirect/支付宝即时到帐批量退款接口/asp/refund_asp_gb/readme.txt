...
※注意※
需要配置的文件是：alipay_config.asp、refund.asp、notify_url.asp

index.asp仅是支付宝提供的付款入口模板文件，可选择使用。
如果商户网站根据业务需求不需要使用，请把refund.asp作为与商户网站网站相衔接页面。
如果需要使用index.asp，那么refund.asp文件无需更改，只需配置好alipay_config.asp文件
