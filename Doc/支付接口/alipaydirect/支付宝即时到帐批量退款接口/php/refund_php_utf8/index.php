...
<HTML XMLNS:CC><HEAD><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
...
<CENTER>
  <BR />
  <FORM name=alipayment onSubmit="return CheckForm();" action=refund.php
method=post target="_blank">
    <TABLE cellSpacing=0 cellPadding=0 width=450 border=0>
      <TR>
        <TD class=font_title valign="middle" height="40">支付宝退款</TD>
      </TR>
      <TR>
