...
Namespace AlipayClass
    ...
    Public Class alipay_config
        ...
        Public Sub alipay_config()
            ...
            'return_url的域名不能写成http://localhost/js_vs2005_vb_gb/return_url.aspx ，否则会导致return_url执行无效
            _return_url = "http://www.xxx.com/js_vs2005_vb_gb/return_url.aspx"

            '交易过程中服务器通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
            _notify_url = "http://www.xxx.com/js_vs2005_vb_gb/notify_url.aspx"
