...
'签约支付宝账号或卖家支付宝帐户
seller_email    = "alipay-test03@alipay.com"

'交易过程中服务器通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
notify_url      = "http://www.xxx.com/js_asp_gb/notify_url.asp"

'付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
return_url      = "http://www.xxx.com/js_asp_gb/return_url.asp"
'return_url的域名不能写成http://localhost/js_asp_gb/return_url.asp，否则会导致return_url执行无效
