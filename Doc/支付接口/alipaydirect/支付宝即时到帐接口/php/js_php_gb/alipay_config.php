...
$notify_url		= "http://www.xxx.cn/js_php_gb/notify_url.php";

//付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
//return_url的域名不能写成http://localhost/js_php_gb/return_url.php ，否则会导致return_url执行无效
$return_url		= "http://www.xxx.cn/js_php_gb/return_url.php";
