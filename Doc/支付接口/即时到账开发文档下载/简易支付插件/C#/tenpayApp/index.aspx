              ...
              <td align="left"><table width="760" height="30" border="0" align="left" cellpadding="0" cellspacing="1" bgcolor="#FFCC00">
                  <tr>
                    ...
                    <table width="760" height="351" border="0" cellpadding="6" cellspacing="0" class="px14" style="display:">
                        ...
                        <td width="353" valign="top"><asp:Label ID="lbl_Name" runat="server"></asp:Label></td>
                        </tr> 
                      <tr>
                      ...
                      <tr>
                        ...
                        <td valign="top"><asp:TextBox ID="order_price" runat="server" onKeyUp="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')"></asp:TextBox>
                        元（格式：500.01）</td>
                      </tr>
                      <tr>
