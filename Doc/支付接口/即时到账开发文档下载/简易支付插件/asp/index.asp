...
<form action="tenpay.asp" method="get" name="directFrm" onSubmit="return payFrm();">
            <tr>
              <td align="left"><table width="760" height="30" border="0" align="left" cellpadding="0" cellspacing="1" bgcolor="#FFCC00">
                  <tr>
                    ...
                    <table width="760" height="351" border="0" cellpadding="6" cellspacing="0" class="px14" style="display:">
                        ...
                        <td width="353" valign="top"><%=request("name")%></td>
                        </tr> 
                      <tr>
                        <td align="right" valign="top">订单编号：</td>
                        <td valign="top">
						<%
'获取时间字符串, 格式YYYYMMDDhhmiss,客户网站订单号,现取系统时间
		Public Function tenpay_util_getStrNow()
		strNow = Now()
		...
		tenpay_util_getStrNow = strNow
	End Function
spname = request("spname")
total_fee = request("total_fee")
dingdan = request("dingdan")
if dingdan="" Then
  dingdan=tenpay_util_getStrNow()
end if
%><%=dingdan%>
			              <input type="hidden" name="order_no" maxlength="50" size="18"  value="<%=dingdan%>"></td>
                      </tr>
                      <tr>
                        <td align="right" valign="top">付款项目：</td>
                        <td valign="top"><span style="color:#000000;font-size:12px;">
                          <input name="product_name" type="text" size="18" maxlength="50" value="<%=spname%>" >
                        </span></td>
                      </tr>
                      <tr>
                        <td align="right" valign="top">付款金额：</td>
                        <td valign="top"><input type="text" name="order_price" maxlength="50" size="18" onKeyUp="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" value="<%=total_fee%>"> 
                        元（格式：500.01）</td>
                      </tr>
                      <tr>
