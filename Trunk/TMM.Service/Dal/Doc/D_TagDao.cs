    ...
    public partial class D_TagDal {
		...
		public IList<D_Tag> GetList(Hashtable param,string orderBy,int first,int rows) 
		{
            ...
            if (string.IsNullOrEmpty(orderBy))
                param.Add("OrderBy", "TagId asc");
			else
                param.Add("OrderBy", orderBy);
				
			String stmtId = "D_Tag.GetList";
			return SqlMapper.Instance().QueryForList<D_Tag>(stmtId, param);
		}
		...
		public D_Tag Get(Int32 tagId) {
			String stmtId = "D_Tag.Get";
			return SqlMapper.Instance().QueryForObject<D_Tag>(stmtId, tagId);
		}
		...
		public bool Delete(Int32 tagId) {
			String stmtId = "D_Tag.Delete";
			int result = SqlMapper.Instance().QueryForObject<int>(stmtId, tagId);
			return result > 0 ? true : false;
		}

        public D_Tag Get(string tagName) {
            string stmtId = "D_Tag.GetByTagName";
            return SqlMapper.Instance().QueryForObject<D_Tag>(stmtId, tagName);
        }
