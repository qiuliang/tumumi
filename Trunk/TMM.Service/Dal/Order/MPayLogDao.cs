...
namespace TMM.Service.Dal.Order {
    ...
    /// 功能描述：
    /// </summary>
    public partial class MPayLogDal {
		...
		public int GetCount(Hashtable param) {
			...
			String stmtId = "MPayLog.GetCount";
		...
		public IList<MPayLog> GetList(Hashtable param,string orderBy,int first,int rows) 
		{
            ...
            if (string.IsNullOrEmpty(orderBy))
                param.Add("OrderBy", "PayId asc");
			else
                param.Add("OrderBy", orderBy);
				
			String stmtId = "MPayLog.GetList";
			return SqlMapper.Instance().QueryForList<MPayLog>(stmtId, param);
		}
		...
		public MPayLog Get(Int32 payId) {
			String stmtId = "MPayLog.Get";
			return SqlMapper.Instance().QueryForObject<MPayLog>(stmtId, payId);
		}
		...
		public bool Delete(Int32 payId) {
			String stmtId = "MPayLog.Delete";
			int result = SqlMapper.Instance().QueryForObject<int>(stmtId, payId);
			return result > 0 ? true : false;
		}
